...
Write-Host "  Script: 29.B._Delete_Local_User.ps1" -ForegroundColor DarkCyan
Write-Host "  ScriptID: ST-WIN-0029" -ForegroundColor Cyan
Write-Host "  Version: 1.1" -ForegroundColor DarkCyan
Write-Host "  Date: 2025-05-22" -ForegroundColor DarkCyan
Write-Host "  Category: Windows > Admin & Security" -ForegroundColor DarkCyan
Write-Host "  Description: Deletes a local user account" -ForegroundColor DarkCyan
