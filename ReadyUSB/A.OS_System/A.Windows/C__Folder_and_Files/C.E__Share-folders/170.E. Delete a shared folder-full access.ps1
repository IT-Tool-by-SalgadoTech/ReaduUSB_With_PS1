...
Write-Host "  Script: 170.E._Delete_a_shared_folder-full_access.ps1" -ForegroundColor DarkCyan
Write-Host "  ScriptID: ST-WIN-0170" -ForegroundColor Cyan
Write-Host "  Version: 1.1" -ForegroundColor DarkCyan
Write-Host "  Date: 2025-05-22" -ForegroundColor DarkCyan
Write-Host "  Category: Windows > Shared Folders" -ForegroundColor DarkCyan
Write-Host "  Description: Removes an active network share (previously created with Everyone full access) by name without deleting the underlying folder" -ForegroundColor DarkCyan
