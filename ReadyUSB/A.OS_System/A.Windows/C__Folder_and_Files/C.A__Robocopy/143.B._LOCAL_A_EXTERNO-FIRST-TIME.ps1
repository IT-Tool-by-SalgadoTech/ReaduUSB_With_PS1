...
Write-Host "  Script: 143.B._LOCAL_A_EXTERNO-FIRST-TIME.ps1" -ForegroundColor DarkCyan
...
Write-Host "  Description: Copies all files and subfolders from a local path to a network share using Robocopy" -ForegroundColor DarkCyan
