...
# Script: 444.D.Disonnect_NordVPN.sh
...
echo -e '\033[0;36m  Script: 444.D.Disonnect_NordVPN.sh\033[0m'
...
if [ $? -eq 0 ]; then
    echo -e "${GREEN}  SUCCESS: NordVPN disconnected.${NC}"
else
    echo -e "${RED}  ERROR: Failed to disconnect NordVPN.${NC}"
fi
