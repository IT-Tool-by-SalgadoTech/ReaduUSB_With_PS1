...
# Script: 444.C.Select_a_Country.sh
# ScriptID: ST-LIN-0444
# Version: 1.0
# Date: 2026-07-01
# Category: Linux > Networks > NordVPN
# Description: Lists NordVPN countries and connects to the chosen one.
...
echo -e '\033[0;36m  Script: 444.C.Select_a_Country.sh\033[0m'
echo -e '\033[0;36m  ScriptID: ST-LIN-0444\033[0m'
echo -e '\033[0;36m  Version: 1.0\033[0m'
echo -e '\033[0;36m  Date: 2026-07-01\033[0m'
echo -e '\033[0;36m  Category: Linux > Networks > NordVPN\033[0m'
echo -e '\033[0;36m  Description: Lists NordVPN countries and connects to the chosen one\033[0m'
