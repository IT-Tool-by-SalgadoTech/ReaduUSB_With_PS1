...
# Script: 496.Check_HID_Devices.sh
# ScriptID: ST-LIN-0496
# Version: 1.0
# Date: 2026-07-01
...
echo -e '\033[0;36m  Script: 496.Check_HID_Devices.sh\033[0m'
echo -e '\033[0;36m  ScriptID: ST-LIN-0496\033[0m'
