...
# Script: 625.Kali_Restart_inside_bios.sh
# ScriptID: ST-LIN-0625
# Version: 1.0
# Date: 2026-07-01
...
echo -e '\033[0;36m  Script: 625.Kali_Restart_inside_bios.sh\033[0m'
echo -e '\033[0;36m  ScriptID: ST-LIN-0625\033[0m'
