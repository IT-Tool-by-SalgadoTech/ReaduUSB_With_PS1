...
# Script: 629.What_Process_are_open.sh
# ScriptID: ST-LIN-0629
# Version: 1.0
# Date: 2026-07-01
...
echo -e '\033[0;36m  Script: 629.What_Process_are_open.sh\033[0m'
echo -e '\033[0;36m  ScriptID: ST-LIN-0629\033[0m'
