...
# Script: 354.UFW_Enable.sh
# ScriptID: ST-LIN-0354
# Version: 1.0
# Date: 2026-07-01
...
echo -e '\033[0;36m  Script: 354.UFW_Enable.sh\033[0m'
echo -e '\033[0;36m  ScriptID: ST-LIN-0354\033[0m'
echo -e '\033[0;36m  Version: 1.0\033[0m'
echo -e '\033[0;36m  Date: 2026-07-01\033[0m'
echo -e '\033[0;36m  Category: Linux > Admin And Security > Firewall UFW\033[0m'
echo -e '\033[0;36m  Description: Enables the UFW firewall\033[0m'
...
if [ $? -eq 0 ]; then
    echo -e "${GREEN}  SUCCESS: UFW enabled.${NC}"
else
