...
# Script: 353.UFW_Disable.sh
# ScriptID: ST-LIN-0353
# Version: 1.0
# Date: 2026-07-01
...
echo -e '\033[0;36m  Script: 353.UFW_Disable.sh\033[0m'
echo -e '\033[0;36m  ScriptID: ST-LIN-0353\033[0m'
echo -e '\033[0;36m  Version: 1.0\033[0m'
echo -e '\033[0;36m  Date: 2026-07-01\033[0m'
echo -e '\033[0;36m  Category: Linux > Admin And Security > Firewall UFW\033[0m'
echo -e '\033[0;36m  Description: Disables the UFW firewall\033[0m'
...
echo -e "${YELLOW}  WARNING: Disabling UFW will leave the firewall inactive.${NC}"
...
if [ $? -eq 0 ]; then
    echo -e "${GREEN}  SUCCESS: UFW disabled.${NC}"
else
