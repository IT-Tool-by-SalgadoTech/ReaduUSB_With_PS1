#!/usr/bin/env bash
# ScriptID: ST-LIN-0652  |  652.Block_MAC.sh
...
it_banner "652.Block_MAC.sh" "ST-LIN-0652" "Resolves a MAC via the neighbour table and blocks it (by IP and by source MAC)"
it_need_root "$@"
