#!/usr/bin/env bash
# ScriptID: ST-LIN-0648  |  648.Emergency_Unlock_usb.sh
...
it_banner "648.Emergency_Unlock_usb.sh" "ST-LIN-0648" "Master USB recovery: reverses every USB lock mechanism from 647"
it_need_root "$@"
