#!/usr/bin/env bash
# ScriptID: ST-LIN-0642  |  646.Check_USB_Status.sh
...
echo "${C_CY}  Script: 642.Check_USB_Status.sh${C_RS}"
echo "${C_CY}  ScriptID: ST-LIN-0642${C_RS}"
echo "${C_CY}  Version: 1.0${C_RS}"
echo "${C_CY}  Date: 2026-07-12${C_RS}"
echo "${C_CY}  Category: Linux > USB${C_RS}"
echo "${C_CY}  Description: Reports whether USB mass-storage devices are enabled or blocked${C_RS}"
