#!/usr/bin/env bash
# ScriptID: ST-LIN-0671  |  671.Sudo_Password_On.sh
...
it_banner "671.Sudo_Password_On.sh" "ST-LIN-0671" "Re-enforces a password prompt for sudo by removing passwordless (NOPASSWD) rules"
it_need_root "$@"
