#!/usr/bin/env bash
# ScriptID: ST-LIN-0665  |  665.Restart_AV_Service.sh
...
it_banner "665.Restart_AV_Service.sh" "ST-LIN-0665" "Ensures the antivirus service (ClamAV daemon + freshclam) is running"
it_need_root "$@"
