#!/usr/bin/env bash
# ScriptID: ST-LIN-0631  |  635.Change_password_account.sh
...
echo "${C_CY}  Script: 631.Change_password_account.sh${C_RS}"
echo "${C_CY}  ScriptID: ST-LIN-0631${C_RS}"
echo "${C_CY}  Version: 1.0${C_RS}"
echo "${C_CY}  Date: 2026-07-12${C_RS}"
echo "${C_CY}  Category: Linux > Admin & Security${C_RS}"
echo "${C_CY}  Description: Changes a local user account password interactively${C_RS}"
