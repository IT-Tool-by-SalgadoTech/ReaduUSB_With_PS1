#!/usr/bin/env bash
# ScriptID: ST-LIN-0654  |  654.Bluetooth_Reset.sh
...
it_banner "654.Bluetooth_Reset.sh" "ST-LIN-0654" "Disables Bluetooth discoverability/fast-pair and resets the Bluetooth stack"
it_need_root "$@"
