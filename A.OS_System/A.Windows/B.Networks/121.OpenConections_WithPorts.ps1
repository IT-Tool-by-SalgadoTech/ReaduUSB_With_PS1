...
Write-Host "  Script: 121.OpenConections_WithPorts.ps1" -ForegroundColor DarkCyan
Write-Host "  ScriptID: ST-WIN-0121" -ForegroundColor Cyan
Write-Host "  Version: 1.1" -ForegroundColor DarkCyan
Write-Host "  Date: 2025-05-22" -ForegroundColor DarkCyan
Write-Host "  Category: Windows > Firewall & Ports" -ForegroundColor DarkCyan
Write-Host "  Description: Lists all established TCP connections with process name, local/remote address and port, and adapter; saves report to Desktop and opens it in Notepad" -ForegroundColor DarkCyan
